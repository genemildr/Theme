<script type="text/html" id="orders-create-note">
	...
	>
		<template #trigger>
			<div class="ts-filter ts-popup-target" @mousedown="$root.activePopup = 'commentForm'" ref="submitInput">
...
<script type="text/html" id="orders-file-field">
	<div class="ts-form-group ts-file-upload">
		...
		<media-popup v-if="showLibrary" @save="onMediaPopupSave" :custom-target="mediaTarget"></media-popup>
