...
?>
<a href="<?= esc_url( add_query_arg( 'chat', 'p'.$current_post->get_id(), get_permalink( \Voxel\get('templates.inbox') ) ?: home_url('/') ) ) ?>" class="ts-action-con" onclick="Voxel.requireAuth(event)">
