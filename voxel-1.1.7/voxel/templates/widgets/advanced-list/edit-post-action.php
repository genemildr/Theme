...
if ( count( $edit_steps ) > 1 ): ?>
	<div class="ts-action-wrap ts-popup-component">
		<a href="#" ref="target" class="ts-action-con" role="button">
		...
		<popup v-cloak>
			<div class="ts-popup-head ts-sticky-top flexify">
				<div class="ts-popup-name flexify">
					...
					<p><?= _x( 'Edit', 'edit post action', 'voxel' ) ?></p>
				</div>
						...
						<li>
							<a href="<?= esc_url( add_query_arg( 'step', $field->get_key(), $current_post->get_edit_link() ) ) ?>" class="flexify">
								...
								<div class="ts-term-icon">
									<?= \Voxel\get_icon_markup( $this->get_settings_for_display('ts_step_ico') ) ?: \Voxel\svg( 'right-arrow.svg' ) ?>
								</div>
							</a>
						</li>
					<?php endforeach ?>
