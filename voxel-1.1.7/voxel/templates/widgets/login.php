...
<div class="ts-auth hidden" data-config="<?= esc_attr( wp_json_encode( $config ) ) ?>">
				...
				<!-- <div class="ts-form-group">
					<div class="switch-slider">
						<div class="onoffswitch">
							<input type="checkbox" v-model="register.terms_agreed" class="onoffswitch-checkbox" tabindex="0">
	...
	<div v-else-if="screen === 'security_privacy'" class="ts-form ts-login">
		...
		<div class="login-section">
			<div class="ts-form-group">
				<label><?= _x( 'Download personal data', 'auth', 'voxel' ) ?></label>
				<small><?= _x( 'Request a copy of all your personal data stored on this site.', 'auth', 'voxel' ) ?></small>
			</div>
			<div class="ts-form-group">
				<a
		...
		<div class="login-section">
			<div class="ts-form-group">
				<label><?= _x( 'Delete account', 'auth', 'voxel' ) ?></label>
				<small><?= _x( 'Delete your account and all associated data.', 'auth', 'voxel' ) ?></small>
			</div>
			<div class="ts-form-group">
