		...
		<div class="library-item" :class="{'vx-disabled': state.processing_package && state.processing_package !== package.id}">
			...
			<div class="lib-content">
				...
				<div class="lib-buttons">
					...
					<a href="#" @click.prevent="installPackage(package)" class="ts-button" :class="{'vx-inert': state.processing_package && state.processing_package === package.id}">
